        ...
        <div class="main__box">
            <?= form_open('/admin/simpan_pengguna_ke_db'); ?>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-input" type="text" id="username" name="username" value="<?= old('full_name'); ?>">
...
document.querySelector('a#show-password').addEventListener('click', (e) => show_password(e));
</script>
<?= $this->endSection(); ?>
